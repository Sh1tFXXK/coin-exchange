...
import com.wc.disruptor.DisruptorTemplate;
import com.wc.domain.EntrustOrder;
import com.wc.mapper.EntrustOrderMapper;
import com.wc.utils.BeanUtils;
...
public class DataLoaderCmdRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        for (EntrustOrder entrustOrder : entrustOrders) {
            disruptorTemplate.onData(
                    BeanUtils.entrustOrder2Order(entrustOrder));
        }
        stopWatch.stop();
