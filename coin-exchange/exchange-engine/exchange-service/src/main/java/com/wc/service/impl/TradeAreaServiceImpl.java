...
import com.wc.feign.CoinServiceFeign;
import com.wc.mapper.TradeAreaMapper;
import com.wc.mappers.TradeAreaDtoMappers;
import com.wc.service.MarketService;
import com.wc.service.TradeAreaService;
import com.wc.service.UserFavoriteMarketService;
import com.wc.vo.MergeDeptVo;
import com.wc.vo.TradeAreaMarketVo;
import com.wc.vo.TradeMarketVo;
...
public class TradeAreaServiceImpl extends ServiceImpl<TradeAreaMapper, TradeArea> implements TradeAreaService {
    ...
    public List<TradeAreaMarketVo> findTradeAreaMarket() {
        // 1 查询所有的交易区域
        List<TradeArea> tradeAreas = list(
    ...
    public List<TradeAreaMarketVo> getUserFavoriteMarkets(Long userId) {
        List<UserFavoriteMarket> userFavoriteMarkets = userFavoriteMarketService.list(
                new LambdaQueryWrapper<UserFavoriteMarket>()
