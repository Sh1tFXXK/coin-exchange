...
import com.wc.domain.SysUserLog;
import com.wc.model.WebLog;
import com.wc.service.SysUserLogService;
...
public class WebLogAdminAspect {
    ...
    */
     ...
     * 1定义切入点
     */
    @Pointcut("execution(* com.wc.controller.*.*(..))")// controller包里面所有类，类里面的所有方法都有该切面
    public void webLog(){}
    ...
    public Object recodeWebLog(ProceedingJoinPoint proceedingJoinPoint)throws Throwable{
        ...
        //因为我们会使用Swagger这工具，我们必须在方法上面添加
        // @ApiOperation(value="")该注解
        //获取ApiOperation
        ...
        //com.wc.controller.UserController.login()
